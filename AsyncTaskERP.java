...
public class AsyncTaskERP extends AsyncTask<String, Integer, String> implements ICancleAsynkTask {
    ...
    private com.orataro.util.LoaderProgress LoaderProgress;
    ...
    public AsyncTaskERP(Context mContext,ArrayList<Property_vo> arraylist,boolean isShowLoader,ResponseWebServices  iResult) {
    ...
    public AsyncTaskERP(Context mContext,ArrayList<Property_vo> arraylist,boolean isShowLoader,ResponseWebServices  iResult,boolean isPersentageDialog,boolean isPersentageDialog1) {
        this.mContext= mContext;
        this.arraylist = arraylist;
        this.iResult = iResult;
        this.isShowLoader = isShowLoader;
    ...
    public AsyncTaskERP(Context mContext,ArrayList<Property_vo> arraylist,boolean isShowLoader,ResponseWebServices  iResult,boolean extraParam,int i) {
        this.mContext= mContext;
        this.arraylist = arraylist;
        this.iResult = iResult;
        this.isShowLoader = isShowLoader;
    ...
    public AsyncTaskERP(Context mContext,ArrayList<Property_vo> arraylist,boolean isShowLoader,ResponseWebServices  iResult,boolean isCancleDialog) {
        this.mContext= mContext;
        this.arraylist = arraylist;
        this.iResult = iResult;
        this.isShowLoader = isShowLoader;
...
//            methodName=params[0];
            ...
            result = new ERPServices(params[1],arraylist,params[0]).ERPProjectCall();
        }else{
